...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    String username = sessionAcc.getAccountname();
    ...
    // Kiểm tra mật khẩu cũ bằng cách query DB với mật khẩu băm
    Account acc = dao.getAccount(username, oldpassword);

    if (!newpassword.equals(confirmnewpassword)) {
        request.setAttribute("error", "New password and confirm password don't match!");
    } else if (acc == null) {
