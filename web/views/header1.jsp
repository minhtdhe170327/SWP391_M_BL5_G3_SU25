                        ...
                        <li class="dropdown">
                            ...
                            <ul>
                                ...
                                <c:if test="${not empty sessionScope.getmentee}">
                                    <li><a href="${contextPath}/ViewMenteeProfile?accmenteeid=${sessionScope.getmentee.accountid}">Profile</a></li>
                                ...
                                <c:if test="${sessionScope.account.roleid == 2 and not empty sessionScope.getmentor}">
                                    <li><a href="${contextPath}/ViewMentorProfile?accmentorid=${sessionScope.getmentor.accountid}">Profile</a></li>
