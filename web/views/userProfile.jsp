...
<head>
    ...
    <style>
        ...
        .profile-container { max-width: 900px; margin-top: 120px; margin-bottom: 50px; }
        .profile-card {
        ...
        .info-item strong { min-width: 150px; color: #555; }
                    ...
                    <c:when test="${sessionScope.account.roleid == 2}">
                        ...
                        <div class="info-item">
                         ...
                         <div class="info-item">
                            ...
                            <div>
                                <c:forEach items="${sessionScope.getmentor.skills}" var="skill">
                        ...
                        <div class="info-item">
                            ...
                            <span><fmt:formatNumber value="${sessionScope.getmentor.cost}" type="currency" currencySymbol="đ" maxFractionDigits="0" /></span>
                        </div>
                         <div class="info-item">
                            <strong>Rating:</strong>
                            <span class="star-rating">
                                <fmt:formatNumber value="${sessionScope.getmentor.averageStar}" maxFractionDigits="1" />
