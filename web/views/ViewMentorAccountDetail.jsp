...
<main class="container profile-container">
    <div class="profile-card">
        <div class="profile-body">
            ...
            <div class="info-item">
                <strong>Role:</strong>
                <input type="text" class="form-control" value="Mentor" disabled>
            </div>
            ...
            <div class="info-item">
                ...
                <input type="text" class="form-control" 
                       value="<fmt:formatDate value='${mentor.birthday}' pattern='yyyy-MM-dd'/>" disabled>
            </div>
            ...
            <div class="info-item">
                ...
                <textarea class="form-control" rows="4" disabled>${mentor.introduce}</textarea>
            </div>
