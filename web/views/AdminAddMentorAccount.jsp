...
<html>
<head>
    <title>Add Mentor Account - Admin</title>
...
<div class="container mt-5">
  <h2 class="mb-4">Add Mentor Account</h2>

  <c:if test="${error != null}">
    <div class="alert alert-danger">${error}</div>
  </c:if>

  <form action="AdminAddMentorAccount" method="post" class="form-container">
    <!-- Username -->
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <textarea name="achievement" class="form-control">${param.achievement}</textarea>
    </div>

    <!-- CostHire -->
    <div class="mb-3">
      <label class="form-label">Cost to Hire</label>
      <input name="costHire" type="number" step="0.01" class="form-control"
             value="${param.costHire}" />
    </div>
    ...
    <!-- Buttons -->
    <div class="mt-4">
      <button type="submit" class="btn btn-success">Add Mentor Account</button>
