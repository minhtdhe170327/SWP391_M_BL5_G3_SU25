...
<head>
    ...
    <title>Add Mentor Account | Admin Dashboard</title>
    <meta name="description" content="Add a new Mentor account to the system. Secure and SEO-friendly Admin Dashboard form."/>
    <meta name="keywords" content="Mentor, Account, Add, Admin, Dashboard"/>
...
<div class="container form-wrapper">
    <div class="form-container">
        <h2><i class="bi bi-person-badge"></i> Add Mentor Account</h2>

        <c:if test="${error != null}">
            <div class="alert alert-danger">${error}</div>
        </c:if>

        <form action="AdminAddMentorAccount" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="achievement" rows="3" class="form-control">${param.achievement}</textarea>
            </div>

            <div class="mb-3">
                <label class="form-label">Cost to Hire</label>
                <input name="costHire" type="number" step="0.01" class="form-control" value="${param.costHire}"/>
            </div>
            ...
            <div class="mt-4 d-flex justify-content-between">
                ...
                <a href="ViewMentorAccount" class="btn btn-secondary"><i class="bi bi-x-circle me-2"></i>Cancel</a>
            </div>
        </form>
    </div>
</div>
