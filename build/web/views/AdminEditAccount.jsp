...
<body>
    ...
    <main class="container profile-container">
        <div class="profile-card">
            <form action="${contextPath}/AdminEditAccount" method="post" class="profile-body">
                <input type="hidden" name="id" value="${editAccount.id}"/>
                <input type="hidden" name="roleid" value="${editAccount.roleid}"/>

                <c:choose>
                    <c:when test="${editAccount.roleid == 1}">
                        <h4>Edit Mentee</h4>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            ...
                            <input type="text" name="firstname" value="${mentee.firstname}" class="form-control"/>
                        </div>
                        <div class="info-item">
                            <strong>Last Name:</strong>
                            <input type="text" name="lastname" value="${mentee.lastname}" class="form-control"/>
                        </div>
                        <div class="info-item">
                            <strong>Email:</strong>
                        ...
                        <div class="info-item">
                            ...
                            <input type="text" name="address" value="${mentee.address}" class="form-control"/>
                        </div>
                        <div class="info-item">
                            <strong>Birthday:</strong>
                            <input type="date" name="birthday" value="<fmt:formatDate value='${mentee.birthday}' pattern='yyyy-MM-dd'/>" class="form-control"/>
                        </div>
                        <div class="info-item">
                            <strong>Gender:</strong>
                            <select name="sex" class="form-select">
                                <option value="M" ${mentee.sex == 'M' ? 'selected' : ''}>Male</option>
                                <option value="F" ${mentee.sex == 'F' ? 'selected' : ''}>Female</option>
                            </select>
                        </div>
                        <div class="info-item">
                            <strong>Introduction:</strong>
                            <textarea name="introduce" class="form-control">${mentee.introduce}</textarea>
                        </div>
                    </c:when>

                    <c:when test="${editAccount.roleid == 2}">
                        <h4>Edit Mentor</h4>
                        <div class="info-item">
                            <strong>Account Name:</strong>
                            <input type="text" name="accountname" value="${editAccount.accountname}" class="form-control"/>
                        ...
                        <div class="info-item">
                            <strong>Birthday:</strong>
                            <input type="date" name="birthday" value="<fmt:formatDate value='${mentor.birthday}' pattern='yyyy-MM-dd'/>" class="form-control"/>
                        </div>
                        <div class="info-item">
                            <strong>Gender:</strong>
                            <select name="sex" class="form-select">
                                <option value="M" ${mentor.sex == 'M' ? 'selected' : ''}>Male</option>
                                <option value="F" ${mentor.sex == 'F' ? 'selected' : ''}>Female</option>
                            </select>
                        </div>
                        <div class="info-item">
                            <strong>Introduction:</strong>
                    ...
                    <c:when test="${editAccount.roleid == 3}">
                        ...
                        <div class="info-item">
                            <strong>Password:</strong>
                            <div class="input-group">
                                <input type="password" id="passwordField3" name="password" value="${editAccount.password}" class="form-control"/>
                                <button type="button" class="btn btn-outline-secondary" onclick="togglePassword('passwordField3', this)">Show</button>
                            </div>
                        </div>
                    </c:when>
                </c:choose>
