...
<head>
    ...
    <title>Mentee Account List | Admin Dashboard</title>
        ...
        <section class="breadcrumbs py-3 bg-light mb-3">
            <div class="container">
                <div class="d-flex justify-content-between align-items-center">
                    <h2 class="mb-0">Mentee Accounts</h2>
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <form action="SearchAccount" method="post" class="search-bar d-flex flex-grow-1 me-3">
                    <input value="${searchtext}" type="text" class="form-control" placeholder="Search Mentee accounts..." name="name">
                    <button type="submit" class="btn btn-secondary"><i class="bi bi-search"></i></button>
                </form>
                <a href="AdminAddMenteeAccount" class="btn btn-success fw-bold">
                    <i class="bi bi-person-plus me-2"></i> Add Mentee
                </a>
            </div>
